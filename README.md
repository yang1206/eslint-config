# @yang1206/eslint-config

This is a forked repository from [@antfu/eslint-config](https://github.com/antfu/eslint-config). All rights belong to the original author.
...
```bash
pnpm i -D eslint @yang1206/eslint-config
```
...
```js
// eslint.config.js
import eslint from '@yang1206/eslint-config'
...
```js
// eslint.config.js
const eslint = require('@yang1206/eslint-config').default
...
```bash
npx @yang1206/eslint-config@latest
```
...
[MIT](./LICENSE) License &copy; 2019-PRESENT [Yang1206](https://github.com/yang1206)
